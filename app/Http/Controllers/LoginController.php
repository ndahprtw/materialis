...
class LoginController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        return view('pages.dashboard', compact('karyawan', 'pemasukan', 'pengeluaran', 'bulanBarang', 'data_total_harga_keluar', 'data_total_harga_masuk', 'tahunIni', 'daftarTahun',   'data_sales', 'banyak_produk'));
    }
}
